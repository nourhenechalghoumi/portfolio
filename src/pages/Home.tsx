...
import { ArrowRight, ArrowUpRight, Download, Sparkles, Zap, Shield, Cpu, Cloud, GitBranch, Workflow } from "lucide-react";
import profile from "@/assets/profile.jpg";
import heroBg from "@/assets/hero-bg.jpg";
import { skills, projects, services } from "@/data/portfolio";
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 -z-10 w-[800px] h-[800px] rounded-full bg-gradient-primary opacity-10 blur-[120px]" />

        <div className="container pt-10 pb-20 md:pt-16 md:pb-28">
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7 animate-fade-up order-2 lg:order-1">
              ...
              <h1 className="mt-6 font-display text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.02] tracking-tight">
                Engineering
                <br />
                <span className="text-gradient">cloud-native</span> systems
                <br />
                <span className="relative inline-block">
                  that don't break.
                  <svg className="absolute -bottom-2 left-0 w-full" viewBox="0 0 300 12" fill="none">
                    <path d="M2 9 C 80 2, 160 14, 298 4" stroke="hsl(var(--primary))" strokeWidth="3" strokeLinecap="round" />
                  </svg>
                </span>
              </h1>
              <p className="mt-7 text-lg text-muted-foreground max-w-xl leading-relaxed">
                I'm <span className="text-foreground font-medium">Nourhene Chalghoumi</span> — a Cloud & DevOps engineer building reliable infrastructure, modern web apps and n8n automations. Currently coordinating <span className="text-primary">JSK Esports</span> and engineering at <span className="text-primary">Eyeotech</span>.
              </p>

              <div className="mt-8 flex flex-wrap gap-3">
                <Link to="/projects" className="group relative inline-flex items-center gap-2 rounded-full bg-gradient-primary px-6 py-3 font-semibold text-primary-foreground shadow-[0_8px_30px_-8px_hsl(var(--primary)/0.6)] hover:shadow-[0_12px_40px_-8px_hsl(var(--primary)/0.8)] transition-all hover:-translate-y-0.5 shine">
                  View Projects
                  <ArrowRight className="group-hover:translate-x-1 transition-transform" size={18} />
                </Link>
                <a href="/cv-nourhene-chalghoumi-fr.pdf" download className="inline-flex items-center gap-2 rounded-full glass px-6 py-3 font-semibold hover:text-primary hover:-translate-y-0.5 transition-all">
                  <Download size={18} /> Télécharger CV (FR)
                </a>
                <Link to="/contact" className="inline-flex items-center gap-2 rounded-full px-6 py-3 font-semibold text-muted-foreground hover:text-foreground transition-colors">
            ...
            <div className="lg:col-span-5 order-1 lg:order-2 flex justify-center lg:justify-end">
              <div className="relative">
                {/* Rotating ring */}
                <div className="absolute -inset-8 rounded-full conic-glow animate-spin-slow opacity-60" />
                <div className="absolute -inset-2 bg-gradient-primary opacity-30 blur-3xl rounded-full" />
                ...
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 glass rounded-full px-4 py-2 flex items-center gap-2 text-xs font-mono whitespace-nowrap">
                  <Sparkles size={14} className="text-primary" /> Open to work · Remote / Tunisia
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Marquee tech strip */}
        <div className="relative border-y border-border/60 bg-card/30 backdrop-blur-sm overflow-hidden">
      ...
      <section className="container py-24">
        <div className="flex items-end justify-between mb-12 flex-wrap gap-4">
          <div>
            ...
            <h2 className="font-display text-4xl md:text-5xl font-bold max-w-2xl">Services tailored for <span className="text-gradient">modern teams</span></h2>
          </div>
      ...
      <section className="container py-24">
        <div className="text-center mb-16">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold max-w-2xl mx-auto">A simple process, <span className="text-gradient">obsessive execution</span></h2>
        </div>
        <div className="grid md:grid-cols-4 gap-5 relative">
          ...
          {[
            ...
            <div key={p.n} className="relative glass rounded-3xl p-6">
              ...
              <h3 className="font-display text-lg font-bold mb-1.5">{p.t}</h3>
      ...
      <section className="container py-24">
        <div className="mb-12">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold">Tools I use daily</h2>
        </div>
