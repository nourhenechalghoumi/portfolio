...
const TechStack = () => {
  ...
  const technologies: TechItem[] = [
    ...
    { name: "OpenStack", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/openstack/openstack-plain.svg" },
    ...
    { name: "n8n", logo: "https://cdn.jsdelivr.net/npm/simple-icons@11.7.0/icons/n8n.svg" },
